...
For this week's assignment, I will be using a few TidyVerse packages, and any dataset fivethirtyeight to create a programming sample “vignette" which will demonstrates how to use one or more of the capabilities of the selected TidyVerse package with your the dataset. 
